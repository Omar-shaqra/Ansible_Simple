...
resource "aws_instance" "kubernetes-machine" {
  ...
  provisioner "file" {
    source      = "/home/OmarShaqra/ITI-DevOps/ansible/aws_ec2.yaml"
    destination = "/home/ubuntu/aws_ec2.yaml"
  }

  provisioner "file" {
    source      = "/home/OmarShaqra/ITI-DevOps/ansible/ansible.cfg"
    destination = "/home/ubuntu/ansible.cfg"
  }

  provisioner "file" {
    source      = "/home/OmarShaqra/ITI-DevOps/ansible/ping_hosts.yaml"
    destination = "/home/ubuntu/ping_hosts.yaml"
  }

  provisioner "file" {
    source      = "/home/OmarShaqra/.ssh/yat-devops-httpd-webserver.pem"
    destination = "/home/ubuntu/.ssh/yat-devops-httpd-webserver.pem"
  }

  provisioner "file" {
    source      = "/home/OmarShaqra/ITI-DevOps/ansible/roles"
    destination = "/home/ubuntu/roles"
  }

  provisioner "file" {
    source      = "/home/OmarShaqra/ITI-DevOps/ansible/setup.yaml"
    destination = "/home/ubuntu/setup.yaml"
  }

  provisioner "file" {
    source      = "/home/OmarShaqra/ITI-DevOps/ansible/env.sh"
  ...
  connection {
    type        = "ssh"
    user        = "ubuntu"
    private_key = file("/home/OmarShaqra/.ssh/yat-devops-httpd-webserver.pem")
    host        = self.public_ip
  }
